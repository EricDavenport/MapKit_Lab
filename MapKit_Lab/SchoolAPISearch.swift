//
//  SchoolAPISearch.swift
//  MapKit_Lab
//
//  Created by Eric Davenport on 2/25/20.
...
struct Schools : Codable & Equatable {
...
struct SchoolAPISearch {
  static func loadSchools(completion: @escaping (Result<Schools,AppError>) -> ()) {
